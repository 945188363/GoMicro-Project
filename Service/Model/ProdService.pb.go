...
var file_ProdService_rawDesc = []byte{
	...
	0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x31, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_ProdService_goTypes = []interface{}{
	(*ProdRequest1)(nil),  // 0: Service.ProdRequest1
	(*ProdResponse1)(nil), // 1: Service.ProdResponse1
	(*ProdModel)(nil),     // 2: Service.ProdModel
}
var file_ProdService_depIdxs = []int32{
	2, // 0: Service.ProdResponse1.data:type_name -> Service.ProdModel
	0, // 1: Service.ProdService1.GetProdList:input_type -> Service.ProdRequest1
	1, // 2: Service.ProdService1.GetProdList:output_type -> Service.ProdResponse1
